  ...
  return (
    <div className="p-6 space-y-4 h-full flex flex-col">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            {displayed.length} lines · {errorCount > 0 && <span className="text-red-500">{errorCount} errors</span>}
      ...
      <div className="flex-1 min-h-0">
        <ScrollArea className="h-full rounded border border-border bg-black/90">
          <div ref={scrollRef} className="p-3 space-y-0.5">
            {displayed.length === 0 ? (
              <p className="text-xs text-gray-500 py-4 text-center">No logs found.</p>
            ) : (
